...
#SBATCH -J "hpc_nsm_att_sluo"   # job name
#SBATCH -o "train_nsm_attention_scaled_luong-%j.out"   # output name
...
srun python3 -m nmt.nmt.nmt \
    ...
    --out_dir=output/models/neural_sparql_machine_attention_scaled_luong \
