...
#SBATCH -J "hpc_nsm_att_bah"   # job name
#SBATCH -o "train_nsm_attention_bahdanau_adam_beam10-%j.out"   # output name
...
srun python3 -m nmt.nmt.nmt \
    --src=en --tgt=sparql \
    --hparams_path=nmt_hparams/neural_sparql_machine_attention_bahdanau_adam_beam10.json \
    --out_dir=output/models/neural_sparql_machine_attention_bahdanau_adam_beam10 \
